...
export default function OlivaPage() {
  return (
    <>
      <Head>
        <title>Villa OLIVA – Two-Bedroom Villa | AEOLINA Collection</title>
        <meta name="description" content="Villa OLIVA is a 150m² two-bedroom villa with private pool, garden views, two bathrooms, and a fully equipped kitchen — perfect for up to 4 guests in Corfu." />
      ...
      <main style={{ fontFamily: 'Arial, sans-serif', paddingTop: '80px', paddingBottom: '40px' }}>
        <section style={{ textAlign: 'center', padding: '20px' }}>
          <h1 style={{ fontSize: '2rem', marginBottom: '10px' }}>Villa OLIVA</h1>
        ...
        <section style={{ padding: '20px', textAlign: 'center' }}>
          <img src="/images/oliva/cover.jpg" alt="Villa OLIVA" style={{ maxWidth: '100%', borderRadius: '10px' }} />
        </section>
